...
Additional desktop platforms may be added in the future.
...
- Updates are delivered as new GitHub releases — install the latest version to upgrade.
- As this is a **release-only repository**, change history lives in release notes rather than source commits.
